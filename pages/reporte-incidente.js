...
const reporte = () => {
    ...
    const fetcher = () => axios('/api/incidente').then(datos => datos.data)
    const { data, error, isLoading } = useSWR('/api/incidente',fetcher,{refreshInterval: 100} )


  return (
    <>
    <LayoutAdmin pagina={`Reportes-incidente`}>
